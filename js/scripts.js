...
function initZabor() {
  ...
  $("<div class='sb-button_point fl-wrap'></div>")
    .duplicate(3)
    .appendTo(".sb-button");
  //   scroll nav------------------
  ...
  if ($(".fs-slider").length > 0) {
    ...
    var j3 = new Swiper(".fs-slider .swiper-container", {
      ...
      on: {
        init: function () {
          var fsslideract = $(".fs-slider .swiper-slide-active").data(
              "fsslideropt1"
            ),
            fsslideract2 = $(".fs-slider .swiper-slide-active").data(
              "fsslideropt2"
            ),
            fsslideract3 = $(".fs-slider .swiper-slide-active").data(
              "fsslideropt3"
            ),
  ...
  if ($(".fs-slider2").length > 0) {
    $(".fs-slider2.thumb-contr .swiper-slide .bg").each(function () {
      ...
      $("<div class='thumb-img'><img src='" + ccasdc3 + "'></div>").appendTo(
        ".thumbnail-wrap"
      );
    });
    $(".thumb-img").on("click", function () {
  ...
  $(
    ".sb-button , .share-btn , .fs-mode , .fw_cb , .closedet_style , .single-carousel_arrow"
  ).on({
    mouseenter: function () {
      TweenMax.to(".element-item ", 0.4, {
  ...
  $(
    ".swiper-container a.box-media-zoom , .horizontal-grid-wrap .thumb-info a , .horizontal-grid-wrap a.box-media-zoom , .fs-slider_align_title a , .swiper-link"
  ).on({
    mouseleave: function () {
      TweenMax.to(".element-item ", 0.4, {
        transformOrigin: "35px 35px",
